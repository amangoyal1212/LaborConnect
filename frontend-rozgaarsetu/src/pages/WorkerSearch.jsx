...
const WorkerCard = ({ worker, onHire }) => {
    ...
    return (
        <div className="worker-card p-4 mb-4 d-flex flex-column flex-md-row align-items-md-center gap-4 slide-up">
            ...
            <div className="flex-grow-1">
                <div className="d-flex align-items-start justify-content-between mb-2">
                    <div>
                        ...
                        <span className="badge bg-orange mb-2">{t(worker.category.toLowerCase())}</span>
                    </div>
                    <div className="text-end">
                        <div className="d-flex align-items-center text-warning fw-bold fs-5">
                            <Star size={20} className="me-1 fill-warning" />
            ...
            <div className="flex-shrink-0">
                <button className="btn btn-primary w-100" onClick={() => onHire(worker)}>
                    {t('hire_me')}
                </button>
            </div>
        </div>
...
const WorkerSearch = () => {
    ...
    const fetchWorkers = async () => {
        setLoading(true);
        try {
            // For demo, we are doing basic category search
    ...
    return (
        <div className="bg-offwhite min-vh-100 py-5 fade-in">
            <div className="container">
                <div className="row mb-5 align-items-center">
                    <div className="col-md-8">
                        <h2 className="display-6 fw-bold text-navy mb-2">{t('find_workers')}</h2>
                        <p className="text-secondary">Browse available skilled laborers and hire directly.</p>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-5 bg-white rounded-4 shadow-sm">
                        <h4 className="text-muted">{t('no_workers')}</h4>
